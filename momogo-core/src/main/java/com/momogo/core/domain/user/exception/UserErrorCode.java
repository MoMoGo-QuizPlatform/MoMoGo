...
public enum UserErrorCode implements ErrorCode {
  ...
  BANNED_USER(1009, "BANNED_USER", HttpStatus.FORBIDDEN, "정지된 계정입니다. 관리자에게 문의하세요."),
  TEMPORARY_PASSWORD_MUST_BE_CHANGED(1010, "TEMPORARY_PASSWORD_MUST_BE_CHANGED", HttpStatus.BAD_REQUEST, "임시 비밀번호 상태에서는 탈퇴할 수 없습니다. 비밀번호를 변경해 주세요.");
