...
public enum ProblemErrorCode implements ErrorCode {
  ...
  PROBLEM_NOT_FOUND(1001, "PROBLEM_NOT_FOUND",
      HttpStatus.NOT_FOUND, "해당 문제를 찾을 수 없습니다."),

  CATEGORY_NOT_FOUND(1002, "CATEGORY_NOT_FOUND",
      HttpStatus.NOT_FOUND, "해당 카테고리를 찾을 수 없습니다."),

  CATEGORY_NAME_DUPLICATED(1003, "CATEGORY_NAME_DUPLICATED",
      HttpStatus.CONFLICT, "이미 존재하는 카테고리 이름입니다."),

  CATEGORY_HAS_PROBLEMS(1004, "CATEGORY_HAS_PROBLEMS",
